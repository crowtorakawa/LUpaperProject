![新增使用者頁面_資料輸入](https://github.com/user-attachments/assets/ff6f8f37-9813-400b-95fe-b24ac81e2c7d)# Biometric Stego-Certificate System (LUpaperProject)
# 臉部辨識數位憑證隱寫系統
...
## 新增使用者頁面_資料輸入
![新增使用者頁面_資料輸入](新增使用者頁面_資料輸入.jpg)

## 辨識啟用中
![辨識啟用中](辨識啟用中.jpg)

## 辨識啟用中_新增後_可辨識身分
![辨識啟用中_新增後_可辨識](辨識啟用中_新增後_可辨識.jpg)

## 辨識啟用中_新增後_可辨識身分
![辨識啟用中_新增後_可辨識身分]辨識啟用中_新增後_可辨識02.jpg)

## 辨識啟用中_新增後_可辨識_但尚未進入畫面
![辨識啟用中_新增後_可辨識_但尚未進入](辨識啟用中_新增後_可辨識03.jpg)

## 隱寫後_供下載
![隱寫後_供下載](隱寫後_供下載.jpg)

## 隱寫後_輸入圖片驗證
![隱寫後_輸入圖片驗證](隱寫後_輸入圖片驗證.jpg)
